...
从**任何书籍文本**中自动提取地名，并生成包含丰富元数据的旅行卡片和旅行路线。
...
1. **提取层** (`place_extractor.py`)
   - 通用正则表达式匹配
   - 中文地名：`[\u4e00-\u9fa5]{2,}`
   - 英文地名：`[A-Z][a-z]+(?:\s+[A-Z][a-z]+)+`
...
|------|---------|---------|
| 文学名著 | "在巴黎的咖啡馆..." | [巴黎, 咖啡馆, ...] |
| 历史传记 | "华盛顿领导独立战争..." | [华盛顿, 费城, ...] |
| 科幻小说 | "飞船降落在火星基地..." | [火星, 基地, ...] |
| 游记 | "我们从曼谷飞往清迈..." | [曼谷, 清迈, ...] |
